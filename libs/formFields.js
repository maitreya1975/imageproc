...
exports.getformfields = function(req, callback) {
    ...
    function useCreds(creds) {
        ...
        if(securityToken != undefined) {
            policy.conditions.push({"x-amz-security-token": securityToken});
        }
